...
export default function Header(){
    ...
    return(
        <header className="max-h-[50vh] max-w-[100vw] bg-backgroundBlue relative p-14 text-center"> 
            ...
            <Link href='/Login'> 
            <Image src={imgLogin} alt="Imagem de login" className="w-20 right-20 absolute top-16 invert"/> 
            </Link>
            ...
            <Link href='/Participantes' className="p-6 font-semibold text-white text-left block"> Participantes </Link>
            </div>
